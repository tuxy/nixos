...
with lib.hm.gvariant;
{
  dconf.settings = {
    ...
    "org/gnome/desktop/app-folders/folders/31d3715f-39d2-4b2f-ae34-1ac7e0e7baff" = {
      apps = [
        "Ravenfield.desktop"
        "Kerbal Space Program.desktop"
        "Insurgency.desktop"
        "BeamNG.drive.desktop"
        "UNBEATABLE [white label].desktop"
        "Muse Dash.desktop"
        "Schedule I.desktop"
        "Euro Truck Simulator 2.desktop"
        "ckan.desktop"
        "Cloud Cutter.desktop"
        "DiRT Rally.desktop"
        "Cities Skylines.desktop"
        ...
        "Unturned.desktop"
        "METAL GEAR SOLID V GROUND ZEROES.desktop"
      ];
      name = "Steam Games";
      translate = false;
    };
